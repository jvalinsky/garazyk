...
func TestTestOrganizationRule_ValidateDirectoryStructure_CorrectLocation(t *testing.T) {
	...
	file := &models.TestFile{
		Path: "/path/to/ATProtoPDS/Tests/Auth/OAuthTests.m",
...
func TestTestOrganizationRule_ValidateDirectoryStructure_WrongDirectory(t *testing.T) {
	...
	file := &models.TestFile{
		Path: "/path/to/ATProtoPDS/Tests/Network/OAuthTests.m",
		Classes: []models.TestClass{
			{
				Name: "OAuthTests",
				Methods: []models.TestMethod{
...
func TestTestOrganizationRule_ValidateDirectoryStructure_TestsRoot(t *testing.T) {
	...
	file := &models.TestFile{
		Path: "/path/to/ATProtoPDS/Tests/OAuthTests.m",
		Classes: []models.TestClass{
			{
				Name: "OAuthTests",
				Methods: []models.TestMethod{
...
func TestTestOrganizationRule_GetDomainFromPath(t *testing.T) {
	...
	tests := []struct {
		...
		{"/path/to/ATProtoPDS/Tests/Auth/OAuthTests.m", DomainAuth},
		{"/path/to/ATProtoPDS/Tests/Network/XrpcTests.m", DomainNetwork},
		{"/path/to/ATProtoPDS/Tests/Core/CBORTests.m", DomainCore},
		{"/path/to/ATProtoPDS/Tests/Database/SQLiteTests.m", DomainDatabase},
		{"/path/to/ATProtoPDS/Tests/Repository/CommitTests.m", DomainRepository},
		{"/path/to/ATProtoPDS/Tests/Sync/FirehoseTests.m", DomainSync},
		{"/path/to/ATProtoPDS/Tests/Identity/DIDTests.m", DomainIdentity},
		{"/path/to/ATProtoPDS/Tests/Security/SSRFTests.m", DomainSecurity},
		{"/path/to/ATProtoPDS/Tests/Integration/E2ETests.m", DomainIntegration},
		{"/path/to/ATProtoPDS/Tests/Admin/ModerationTests.m", DomainAdmin},
		{"/path/to/ATProtoPDS/Tests/Services/AccountServiceTests.m", DomainServices},
		{"/path/to/ATProtoPDS/Tests/UnknownDir/SomeTests.m", DomainUnknown},
		{"/path/to/ATProtoPDS/Tests/SomeTests.m", DomainUnknown},
	}
...
func TestTestOrganizationRule_IsInTestsRoot(t *testing.T) {
	...
	tests := []struct {
		...
		{"/path/to/ATProtoPDS/Tests", true},
		{"/path/to/ATProtoPDS/Tests/Auth", false},
		{"/path/to/ATProtoPDS/Tests/Network/Subdir", false},
...
func TestTestOrganizationRule_ValidateMethodLevel_NoFindings(t *testing.T) {
	...
	file := &models.TestFile{
		Path: "/path/to/ATProtoPDS/Tests/Auth/SomeTests.m",
	}
...
func TestTestOrganizationRule_ValidateDirectoryStructure_FixturesDirectory(t *testing.T) {
	...
	file := &models.TestFile{
		Path:    "/path/to/ATProtoPDS/Tests/fixtures/example.json",
		Classes: []models.TestClass{},
	}
