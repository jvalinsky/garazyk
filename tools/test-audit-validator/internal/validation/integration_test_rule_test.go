...
func TestIntegrationTestRule_IsIntegrationTest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			file: &models.TestFile{
				Path: "ATProtoPDS/Tests/Integration/SomeTests.m",
			},
			expected: true,
		},
		{
			...
			file: &models.TestFile{
				Path: "ATProtoPDS/Tests/SomeTests.m",
			},
			expected: true,
		},
		{
		...
		},
		{
			...
			file: &models.TestFile{
				Path: "ATProtoPDS/Tests/Core/UnitTests.m",
			},
			expected: false,
		},
	}
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := ValidationContext{
				TestFile: &models.TestFile{
					Path: "ATProtoPDS/Tests/Integration/IntegrationTests.m",
				},
...
func TestIntegrationTestRule_CheckResourceCleanup_DeterministicResourceOrder(t *testing.T) {
	...
	ctx := ValidationContext{
		TestFile:   &models.TestFile{Path: "ATProtoPDS/Tests/Integration/IntegrationTests.m"},
		TestClass:  &models.TestClass{Name: "IntegrationTests"},
		TestMethod: method,
	}
