...
## Description
`parse_statement()` doesn't recognize `static` and `extern` keywords, sending them to expression parser instead of type/variable declaration parser. Results in "Unknown identifier" errors.
