...
export const sidebarConfig: DefaultTheme.Sidebar = [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: 'Documentation Map', link: '/11-reference/documentation-map' },
      ...
      { text: 'Admin UI Documentation', link: '/11-reference/admin-ui-documentation' },
      { text: 'Source-Adjacent Documentation', link: '/11-reference/source-adjacent-documentation' },
      { text: 'Tooling and Skills Documentation', link: '/11-reference/tooling-and-skills-documentation' },
