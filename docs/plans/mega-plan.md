...
12. **Open (added 2026-08-03):** make Garazyk's DASL (dasl.ing) implementation
    ...
    `c2pa.hash.bmff.v3` root-box hashing + `c2pa.soft-binding` encode landed
    2026-08-13; claim-store / Merkle / soft-alg remainders open) and Web Tiles
    Deno package / live embed remainders
