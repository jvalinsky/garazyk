...
Documentation that lives alongside source code rather than in `docs/`. These 32 files are
co-located with the modules they describe and are updated alongside code changes.
...
| File | Module |
|---|---|
| `Garazyk/Sources/Admin/ADMINUI_ARCHITECTURE.md` | Architecture |
| `Garazyk/Sources/Admin/ADMINUI_DELIVERY_SUMMARY.md` | Delivery |
| `Garazyk/Sources/Admin/ADMINUI_IMPLEMENTATION_STATUS.md` | Status |
| `Garazyk/Sources/Admin/ADMINUI_INTEGRATION_COMPLETE.md` | Integration |
| `Garazyk/Sources/Admin/ADMINUI_INTEGRATION.md` | Integration guide |
