...
`docs/` is the canonical source of truth for contributor-facing documentation.

## Canonical Path

1. [Contributor Guide](../index)
2. [Getting Started](../01-getting-started/overview)
3. [Tutorials](../10-tutorials/index)
4. [Reference](./api-reference)

## Cross-Repository Hubs
...
- [Planning Archive](../archive/planning/README)
