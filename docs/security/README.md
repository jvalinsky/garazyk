...
| [SSRF_PROTECTION.md](SSRF_PROTECTION) | SSRF Protection for Handle Resolution | Server-side request forgery protection for handle resolution |
...
- **OAuth2 Security**: [../oauth2/security.md](../oauth2/security) - OAuth2 security implementation
- **Admin Auth**: [../oauth2/admin-auth.md](../oauth2/admin-auth) - Admin authentication details
- **DPoP Implementation**: [../oauth2/dpop.md](../oauth2/dpop) - DPoP proof validation
- **Security Tests**: [../tests/05-security/README.md](../tests/05-security/README) - Security test documentation
- **Token Management**: [../oauth2/token-management.md](../oauth2/token-management) - Token lifecycle
