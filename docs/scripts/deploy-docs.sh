...
if [ "$DEPLOY_ENV" = "production" ]; then
    ...
    if [ -f "/home/exedev/objpds/docker/docs/docker-compose.yml" ]; then
        echo "Deploying on production server (crimson-comet.exe.xyz)"
        ...
        echo "To deploy to production, run this script on crimson-comet.exe.xyz"
