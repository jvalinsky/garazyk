...
<script setup>
const mockJWTCode = `#import <Foundation/Foundation.h>
...
const exercise1Code = mockJWTCode + `
...
const exercise2Code = mockJWTCode + `
...
### 📝 Exercise 1: Implement Base64URL Decoding

Implement a helper to decode a Base64URL string (used for JWT parts):
