...
You've secured your PDS with JWT signing, verification, and standard OAuth 2.0 endpoints required for AT Protocol clients.

## Next Steps

- **[Tutorial 5: Firehose](tutorial-5-firehose)** — Sync repository changes to the network
