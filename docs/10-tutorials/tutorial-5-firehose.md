...
1. Continue to [Tutorial 6: Deployment](./tutorial-6-deployment).
2. Use [Testing Map](../11-reference/testing-map) to choose focused sync and integration suites.
3. Revisit [Tutorial 3: Records](./tutorial-3-records) whenever firehose behavior depends on write semantics.
