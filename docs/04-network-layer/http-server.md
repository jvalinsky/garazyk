...
- **Route Dispatch**: `ATProtoHttpServerBuilder` maps incoming request paths to route families (e.g., XRPC, OAuth).
...
- **`ATProtoHttpServerBuilder`**: Configures the route registry and installation order during boot.
