...
@property (nonatomic, copy, nullable) NSString *currentCursor;
...
@property (nonatomic, strong, nullable) Firehose *firehose;
@property (nonatomic, strong, nullable) FirehoseSubscription *subscription;
@property (nonatomic, strong) NSMutableDictionary<NSString *, NSString *> *cursorStorage;
...
- (NSURL *)buildWebSocketURL {
    ...
    uint16_t port = self.serverURL.port ? self.serverURL.port.uintValue : 443;
