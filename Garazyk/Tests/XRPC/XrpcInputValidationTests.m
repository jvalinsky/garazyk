...
- (void)testQueryParamBoolean {
    ...
    [self.dispatcher registerMethod:@"test.boolParam" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
    ...
    // Test boolean=true
    ATProtoHttpRequest *requestTrue = [self createGetRequest:@"/xrpc/test.boolParam" queryString:@"enabled=true"];
    ATProtoHttpResponse *responseTrue = [[ATProtoHttpResponse alloc] init];
    ...
    // Test boolean=false
    ATProtoHttpRequest *requestFalse = [self createGetRequest:@"/xrpc/test.boolParam" queryString:@"enabled=false"];
    ATProtoHttpResponse *responseFalse = [[ATProtoHttpResponse alloc] init];
...
- (void)testQueryParamIntegerReturnsExpectedLimit {
    ...
    [self.dispatcher registerMethod:@"test.intParam" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        receivedLimit = request.queryParams[@"limit"];
        response.statusCode = HttpStatusOK;
    }];
    
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/test.intParam" queryString:@"limit=50"];
...
- (void)testQueryParamArrayFormatReturnsExpectedTagsSize {
    ...
    [self.dispatcher registerMethod:@"test.arrayParam" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        // XRPC uses repeated params for arrays: ?tag=a&tag=b
        receivedTags = request.queryParams[@"tag"];
        response.statusCode = HttpStatusOK;
    }];
    
    // Note: This depends on how ATProtoHttpRequest handles repeated query params
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/test.arrayParam" queryString:@"tag=blue&tag=green&tag=red"];
    ATProtoHttpResponse *response = [[ATProtoHttpResponse alloc] init];
    [self.dispatcher handleRequest:request response:response];
...
- (void)testRequiredParamMissing {
    ...
    [self.dispatcher registerMethod:@"test.requiredParam" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
    ...
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/test.requiredParam" queryString:@""];
    ATProtoHttpResponse *response = [[ATProtoHttpResponse alloc] init];
    [self.dispatcher handleRequest:request response:response];
...
- (void)testOptionalParamOmittedReturnsOk {
    __block BOOL handlerCalled = NO;
    [self.dispatcher registerMethod:@"test.optionalParam" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
    ...
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/test.optionalParam" queryString:@""];
    ATProtoHttpResponse *response = [[ATProtoHttpResponse alloc] init];
    [self.dispatcher handleRequest:request response:response];
...
- (void)testMaxQueryLengthValidatesResponseStatusCodeOrBadRequest {
    [self.dispatcher registerMethod:@"test.longQuery" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        response.statusCode = HttpStatusOK;
    }];
    ...
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/test.longQuery" queryString:longQuery];
    ATProtoHttpResponse *response = [[ATProtoHttpResponse alloc] init];
    [self.dispatcher handleRequest:request response:response];
...
- (void)testBodySizeLimitDefaultIsSuccessful {
    ...
    [self.dispatcher registerMethod:@"test.postBody" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        handlerReached = YES;
        response.statusCode = HttpStatusOK;
    }];
...
- (void)testPostWithoutContentTypeIsSuccessful {
    [self.dispatcher registerMethod:@"test.noContentType" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        response.statusCode = HttpStatusOK;
    }];
...
- (void)testPostWithJsonContentType {
    ...
    [self.dispatcher registerMethod:@"test.jsonBody" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
...
- (void)testPostWithIncorrectContentType {
    [self.dispatcher registerMethod:@"test.wrongType" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        NSString *contentType = [request headerForKey:@"content-type"];
...
- (void)testEmptyPathIsSuccessful {
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/" queryString:@""];
    ATProtoHttpResponse *response = [[ATProtoHttpResponse alloc] init];
    [self.dispatcher handleRequest:request response:response];
...
- (void)testBadQueryStringValidatesResponseStatusCodeOr400 {
    [self.dispatcher registerMethod:@"test.malformedQuery" handler:^(ATProtoHttpRequest *request, ATProtoHttpResponse *response) {
        response.statusCode = HttpStatusOK;
    }];
    
    // Query with invalid encoding
    ATProtoHttpRequest *request = [self createGetRequest:@"/xrpc/test.malformedQuery" queryString:@"key=%ZZ"];
    ATProtoHttpResponse *response = [[ATProtoHttpResponse alloc] init];
...
- (ATProtoHttpRequest *)createGetRequest:(NSString *)path queryString:(NSString *)queryString {
