...
- (void)testDefaultRetention {
    ATProtoRelayEventBuffer *buffer = [[ATProtoRelayEventBuffer alloc] initWithRetentionHours:72 maxEvents:100000];
    XCTAssertEqual(buffer.retentionSeconds, 259200);
}

- (void)testCustomRetentionWindow {
    ATProtoRelayEventBuffer *buffer = [[ATProtoRelayEventBuffer alloc] initWithRetentionHours:24 maxEvents:10000];
