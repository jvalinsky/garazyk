...
- (void)testDefaultFilterAllowsAll {
    ATProtoRelayEventFilter *filter = [[ATProtoRelayEventFilter alloc] initWithAllowedCollections:nil allowedRepos:nil blockedActors:nil];
...
- (void)testAllowListFilters {
    ATProtoRelayEventFilter *filter = [[ATProtoRelayEventFilter alloc] initWithAllowedCollections:@[@"app.bsky.feed.post", @"app.bsky.feed.like"] allowedRepos:nil blockedActors:nil];
    XCTAssertTrue([filter shouldForwardCollection:@"app.bsky.feed.post"]);
...
- (void)testDenyListFilters {
    ATProtoRelayEventFilter *filter = [[ATProtoRelayEventFilter alloc] initWithAllowedCollections:nil allowedRepos:nil blockedActors:@[@"did:plc:blocked"]];
    XCTAssertTrue([filter shouldForwardActor:@"did:plc:other"]);
    XCTAssertFalse([filter shouldForwardActor:@"did:plc:blocked"]);
}

- (void)testRepoFilter {
    ATProtoRelayEventFilter *filter = [[ATProtoRelayEventFilter alloc] initWithAllowedCollections:nil allowedRepos:@[@"did:plc:allowed"] blockedActors:nil];
...
- (void)testEventFilterCombines {
    ATProtoRelayEventFilter *filter = [[ATProtoRelayEventFilter alloc] initWithAllowedCollections:@[@"app.bsky.feed.post"] allowedRepos:@[@"did:plc:allowed"] blockedActors:nil];
