...
static NSDictionary<NSString *, NSString *> *PDSBuildCategoryMap(void) {
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSDictionary<NSString *, NSArray<NSString *> *> *categoryPatterns = @{
      ...
      @"Germ":           @[@"Germ"],
      @"Core":           @[@"CID", @"ATProtoTID", @"ATProtoBase58", @"ATProtoCore",
      ...
      @"CharacterizationTests": @[@"ActorStoreCharacterization",
                                  ...
                                  @"XrpcRoutePackDecompositionCharacterization",
      ...
      @"Media":          @[@"ATProtoMedia", @"PDSVideo", @"ATProtoVideo", @"MimeType", @"JelczCLI", @"JelczCommand"],
      ...
      @"Registration":   @[@"PDSRegistrationGate", @"PDSCaptchaRegistrationGate"],
...
int main(int argc, char *argv[]) {
  ...
  @autoreleasepool {
    ...
    NSArray *testClasses = @[
      ...
      @"PLCOperationTests",
      @"PLCStoreTests",
      @"PLCAdminSnapshotTests",
      @"PLCAdminUIPackTests",
      @"PLCReplicaStoreTests",
      @"PLCAuditorTests",
      @"PLCServerTests",
      @"PLCReplicaServerTests",
      @"CampagnolaCommandTests",
      @"OAuthPKCETests",
      ...
      @"ATProtoLexiconSchemaTests",
      @"ATProtoLexiconValidatorTests",
      @"ATProtoLexiconRegistryTests",
      ...
      @"XrpcRoutePackDecompositionCharacterizationTests",
      ...
      @"CFReleaseTests",
      @"PlatformGuardTests",
      @"PDSWebSocketNetworkAdapterTests",
      ...
      @"PDSCaptchaRegistrationGateTests",
      ...
      @"ATProtoHttpWellKnownRoutePackTests",
      @"ATProtoTIDTests",
      ...
      @"ATProtoIrohBlobHashMappingTests",
      ...
      @"JelczStreamplacePeerDemoTests",
      @"JelczIrohSidecarBlobFetcherTests",
      @"JelczIrohSidecarMirrorIntegrityTests",
      @"JelczP2PConfigurationTests",
      @"JelczStreamplaceIrohBridgeTests",
