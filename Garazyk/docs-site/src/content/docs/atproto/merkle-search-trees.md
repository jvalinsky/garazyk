...
Our high-performance server implementation permanently resides under `Garazyk/Sources/Repository/`. Because repeatedly calculating deeply nested SHA-256 hashes of CBOR-encoded objects is tremendously CPU-intensive, we rigorously optimize our MST implementation directly on the metal natively.
