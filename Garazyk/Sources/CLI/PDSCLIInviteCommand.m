...
- (NSString *)usage {
    return @"kaszlak invite <subcommand> [options]";
}
...
- (NSString *)helpText {
    return @"Manage invite codes for account registration.\n\n"
           @"Usage: kaszlak invite <subcommand> [options]\n\n"
           @"Subcommands:\n"
           @"  list                   List all invite codes\n"
           @"  create                 Create a new invite code\n"
           @"  revoke <code>          Revoke an invite code\n\n"
           @"Examples:\n"
           @"  kaszlak invite list                        # List all invite codes\n"
           @"  kaszlak invite create                     # Create new invite (uses default 1 max use)\n"
           @"  kaszlak invite create --max-uses 5         # Create invite with 5 max uses\n"
           @"  kaszlak invite revoke ABC123              # Revoke a specific invite code";
}
