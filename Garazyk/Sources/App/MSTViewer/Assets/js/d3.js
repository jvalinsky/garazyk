...
!function (t, n) {
  ...
  function Z(t, n, e) {
    ...
    for (;;) {
      ...
      i > 0
        ...
        : i < 0 && (t = Math.ceil(t * i) / i, n = Math.floor(n * i) / i), r = i;
    }
  }
  function K(t) {
  ...
  function tt(t, n) {
    ...
    if (void 0 === n) {
      for (const n of t) ++i, null != n && (e < n || void 0 === e && n >= n) && (e = n, r = i);
        ...
        null != (o = n(o, ++i, t)) && (e < o || void 0 === e && o >= o) && (e = o, r = i);
      }}
    return r;
  }
  function nt(t, n) {
  ...
  function at(t, n, e) {
    if (
      t = Float64Array.from(function* (t, n) {
  ...
  function Pt(t, n) {
    ...
    function h(h) {
      ...
      x = x.merge(
        ...
        S = S.merge(
          T.append("text").attr("fill", "currentColor").attr(s, f * g).attr(
            "dy",
            t === xt ? "0em" : t === Mt ? "0.71em" : "0.32em",
          ),
        ),
        h !== m &&
        (x = x.transition(h),
        ...
        A.attr(s + "2", f * o),
        S.attr(s, f * g).text(p),
        m.filter(Ct).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif")
  ...
  function rn(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < l; ++u) {
      (c = n[u]) &&
        (d[u] = f = a.call(c, c.__data__, u, n) + "", s.has(f) ? i[u] = c : s.set(f, c));
    }
    for (u = 0; u < h; ++u) {
      f = a.call(t, o[u], u, o) + "",
  ...
  Vn.prototype = Wn.prototype = {
    ...
    select: function (t) {
      ...
      for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i) {
        for (var o, a, u = n[i], c = u.length, f = r[i] = new Array(c), s = 0; s < c; ++s) {
          (o = u[s]) && (a = t.call(o, o.__data__, s, u)) &&
    ...
    merge: function (t) {
      for (
        ...
        for (
          var f, s = e[c], l = r[c], h = s.length, d = u[c] = new Array(h), p = 0;
          p < h;
          ++p
        ) (f = s[p] || l[p]) && (d[p] = f);
      }
  ...
  function ae(t) {
    var n = t.document.documentElement, e = Zn(t).on("dragstart.drag", oe, re);
    "onselectstart" in n
      ? e.on("selectstart.drag", oe, re)
      : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none");
  }
  function ue(t, n) {
    var e = t.document.documentElement, r = Zn(t).on("dragstart.drag", null);
      ...
      (n = we.exec(t))
        ? (e = n[1].length,
          ...
          6 === e
            ? $e(n)
            : 3 === e
            ? new qe(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1)
            : 8 === e
  ...
  function Ie() {
    ...
    return `${1 === t ? "rgb(" : "rgba("}${Be(this.r)}, ${Be(this.g)}, ${Be(this.b)}${
      1 === t ? ")" : `, ${t})`
    }`;
  }
  function Oe(t) {
  ...
  pe(ye, ze, {
      ...
      ge(ye, {
        ...
        displayable() {
          return -.5 <= this.r && this.r < 255.5 && -.5 <= this.g && this.g < 255.5 &&
            -.5 <= this.b && this.b < 255.5 && 0 <= this.opacity && this.opacity <= 1;
        },
        hex: Ue,
        formatHex: Ue,
        formatHex8: function () {
          return `#${Ye(this.r)}${Ye(this.g)}${Ye(this.b)}${
            Ye(255 * (isNaN(this.opacity) ? 1 : this.opacity))
          }`;
        },
        formatRgb: Ie,
        toString: Ie,
    ...
    pe(
      ...
      ge(ye, {
        ...
        formatHsl() {
          const t = Oe(this.opacity);
          return `${1 === t ? "hsl(" : "hsla("}${Ge(this.h)}, ${100 * Ve(this.s)}%, ${
            100 * Ve(this.l)
          }%${1 === t ? ")" : `, ${t})`}`;
        },
      }),
  ...
  function or(t) {
    ...
    return r === i && i === o
      ? n = e = a
      : (n = cr((.4360747 * r + .3850649 * i + .1430804 * o) / Qe),
  ...
  pe(
    ...
    ge(ye, {
      ...
      rgb() {
        ...
        return new qe(
          sr(
            3.1338561 * (n = Qe * fr(n)) - 1.6168667 * (t = Je * fr(t)) -
              .4906146 * (e = tr * fr(e)),
          ),
          sr(-.9787684 * n + 1.9161415 * t + .033454 * e),
          sr(.0719453 * n - .2289914 * t + 1.4052427 * e),
          this.opacity,
        );
      },
    }),
  ...
  function Sr(t, n, e, r, i) {
    var o = t * t, a = o * t;
    return ((1 - 3 * t + 3 * o - a) * n + (4 - 6 * o + 3 * a) * e +
      (1 + 3 * t + 3 * o - 3 * a) * r + a * i) / 6;
  }
  function Er(t) {
    var n = t.length - 1;
    return function (e) {
  ...
  function Ki(t, n) {
    var e;
    return ("number" == typeof n ? Yr : n instanceof ze ? Dr : (e = ze(n)) ? (n = e, Dr) : Xr)(
      t,
      n,
    );
  }
  ...
  po.prototype = go.prototype = {
    ...
    select: function (t) {
      ...
      for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a) {
        for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h) {
          (u = f[h]) && (c = t.call(u, u.__data__, h, f)) &&
    ...
    selectAll: function (t) {
      ...
      for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u) {
        for (var c, f = r[u], s = f.length, l = 0; l < s; ++l) {
          if (c = f[l]) {
            for (
              var h, d = t.call(c, c.__data__, l, f), p = Xi(c, e), g = 0, y = d.length;
              g < y;
              ++g
            ) {
    ...
    transition: function () {
      for (
        var t = this._name, n = this._id, e = yo(), r = this._groups, i = r.length, o = 0;
        o < i;
        ++o
      ) {
    ...
    attr: function (t, n) {
      var e = It(t), r = "transform" === e ? ni : Ki;
      ...
      return null == n
        ? this.styleTween(
          ...
          function (t, n) {
            var e, r, i;
            return function () {
              var o = _n(this, t), a = (this.style.removeProperty(t), _n(this, t));
        ...
        ? this.styleTween(
          ...
          function (t, n, e) {
            var r, i, o;
            return function () {
              var a = _n(this, t), u = e(this), c = u + "";
              return null == u && (this.style.removeProperty(t), c = u = _n(this, t)),
          ...
          return function () {
            var c = Hi(this, t), f = c.on, s = null == c.value[a] ? o || (o = lo(n)) : void 0;
    ...
    easeVarying: function (t) {
      ...
      return new Promise(function (o, a) {
        ...
        e.each(function () {
          var e = Hi(this, r), i = e.on;
          i !== t &&
          ((n = (t = i).copy())._.cancel.push(u), n._.interrupt.push(u), n._.end.push(c)), e.on = n;
        }), 0 === i && o();
      });
    },
  ...
  var Oo = 1.70158,
    ...
    Lo = function t(n) {
      function e(t) {
        return ((t *= 2) < 1 ? t * t * ((n + 1) * t - n) : (t -= 2) * t * ((n + 1) * t + n) + 2) /
          2;
      }
      return n = +n, e.overshoot = t, e;
    }(Oo),
  ...
  function wa(t) {
    ...
    function c(n) {
      ...
      e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr(
        "cursor",
        ha.overlay,
      ).merge(e).each(function () {
        var t = xa(this).extent;
        Zn(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr(
          "height",
          t[1][1] - t[0][1],
        );
      }),
        n.selectAll(".selection").data([va("selection")]).enter().append("rect").attr(
          "class",
          "selection",
        ).attr("cursor", ha.selection).attr("fill", "#777").attr("fill-opacity", .3).attr(
          "stroke",
          "#fff",
      ...
      r.exit().remove(),
        ...
        n.each(f).attr("fill", "none").attr("pointer-events", "all").on("mousedown.brush", h)
          .filter(i).on("touchstart.brush", h).on("touchmove.brush", d).on(
            "touchend.brush touchcancel.brush",
            p,
          ).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
    }
    function f() {
      var t = Zn(this), n = xa(this).selection;
      n
        ? (t.selectAll(".selection").style("display", null).attr("x", n[0][0]).attr("y", n[0][1])
          .attr("width", n[1][0] - n[0][0]).attr("height", n[1][1] - n[0][1]),
        ...
        : t.selectAll(".selection,.handle").style("display", "none").attr("x", null).attr("y", null)
    ...
    function h(e) {
                ...
                m === na &&
                  (t.altKey
                    ? (x && (l = h - C * x, i = a + C * x),
                      w && (d = p - P * w, u = c + P * w),
                      m = ra)
                    : (x < 0 ? l = h : x > 0 && (i = a), w < 0 ? d = p : w > 0 && (u = c), m = ea),
                    F.attr("cursor", ha[b]),
                    I(t));
                break;
              default:
      ...
      function I(t) {
        ...
        (x *= -1,
          ...
          (M.selection = [[a, c], [h, p]], f.call(_), D.brush(t, m.name));
      }
      function O(t) {
        if (
          function (t) {
        ...
        for (const e of s) {
          ...
          if (t) {
            ...
            for (const r of t) {
              ...
              } else {(l[e * c + r] || (l[e * c + r] = { source: null, target: null })).source = {
                  index: e,
                  startAngle: n,
  ...
  let Ua = class {
      ...
      if (null === this._x1) this._append`M${this._x1 = t},${this._y1 = n}`;
        ...
        if (Math.abs(s * u - c * f) > Ra && i) {
          ...
          Math.abs(b - 1) > Ra && this._append`L${t + b * f},${n + b * s}`,
            this._append`A${i},${i},0,0,${+(s * h > f * d)},${this._x1 = t + m * u},${this._y1 = n +
              m * c}`;
    ...
    arc(t, n, e, r, i, o) {
      ...
      null === this._x1
        ...
        (l < 0 && (l = l % Da + Da),
          l > Fa
            ? this._append`A${e},${e},0,1,${s},${t - a},${n - u}A${e},${e},0,1,${s},${this._x1 =
              c},${this._y1 = f}`
            : l > Ra &&
              this._append`A${e},${e},0,${+(l >= $a)},${s},${this._x1 = t + e * Math.cos(i)},${this
                ._y1 = n + e * Math.sin(i)}`);
    }
    rect(t, n, e, r) {
  ...
  function Wa(t) {
    var n = Ya, e = La, r = ja, i = ja, o = Ha, a = Xa, u = Ga, c = null;
    function f() {
      var f,
  ...
  function iu() {
        ...
        function p(t) {
          ...
          (n = d[f])
            ? (e = h[s])
              ? (delete d[n.end],
                delete h[e.start],
                n === e ? (n.ring.push(c), i(n.ring)) : h[n.start] = d[e.end] = {
                  start: n.start,
                  end: e.end,
            ...
            ? (e = d[f])
              ? (delete h[n.start],
                delete d[e.end],
                n === e ? (n.ring.push(c), i(n.ring)) : h[e.start] = d[n.end] = {
                  start: e.start,
                  end: n.end,
    ...
    function u(e, r, i) {
      e.forEach(function (e) {
        var o = e[0], a = e[1], u = 0 | o, c = 0 | a, f = uu(r[c * t + u]);
  ...
  function Mu(t, n, e, r, i, o) {
    const a = (n - o) * (e - i), u = (t - i) * (r - o), c = a - u, f = Math.abs(a + u);
  ...
  class Su {
    ...
    update() {
      ...
      const g = t[2 * h], y = t[2 * h + 1];
      for (let n = 0, e = 1 / 0; n < o; n++) {
        if (n === h) continue;
        const r = Eu(g, y, t[2 * n], t[2 * n + 1]);
        r < e && r > 0 && (d = n, e = r);
      }
      let v = t[2 * d], _ = t[2 * d + 1], b = 1 / 0;
      for (let n = 0; n < o; n++) {
        if (n === h || n === d) continue;
        const e = ku(g, y, v, _, t[2 * n], t[2 * n + 1]);
        e < b && (p = n, b = e);
      }
      let m = t[2 * p], x = t[2 * p + 1];
      if (b === 1 / 0) {
    ...
    arc(t, n, e) {
      ...
      null === this._x1
        ...
        : (Math.abs(this._x1 - r) > Du || Math.abs(this._y1 - i) > Du) &&
          (this._ += "L" + r + "," + i),
        e &&
        (this._ += `A${e},${e},0,1,1,${t - e},${n}A${e},${e},0,1,1,${this._x1 = r},${this._y1 =
          i}`);
    }
    rect(t, n, e, r) {
  ...
  class qu {
    ...
    renderCell(t, n) {
      const e = null == n ? n = new Ru() : void 0, r = this._clip(t);
    ...
    *neighbors(t) {
          ...
          if (t) {
            t: for (let r = 0, i = n.length; r < i; r += 2) {
              for (let o = 0, a = t.length; o < a; o += 2) {
                if (
                  n[r] === t[o] && n[r + 1] === t[o + 1] && n[(r + 2) % i] === t[(o + a - 2) % a] &&
                  n[(r + 3) % i] === t[(o + a - 1) % a]
                ) {
                  yield e;
                  break t;
    ...
    _clipInfinite(t, n, e, r, i, o) {
      ...
      } else {this.contains(t, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2) &&
          (u = [
            this.xmin,
            this.ymin,
            this.xmax,
    ...
    _edgecode(t, n) {
      return (t === this.xmin ? 1 : t === this.xmax ? 2 : 0) |
  ...
  class Lu {
    static from(t, n = Ou, e = Bu, r) {
      return new Lu(
        "length" in t
          ...
          : Float64Array.from(function* (t, n, e, r) {
            let i = 0;
    ...
    *neighbors(t) {
    ...
    render(t) {
      const n = null == t ? t = new Ru() : void 0, { points: e, halfedges: r, triangles: i } = this;
    ...
    renderPoints(t, n) {
      void 0 !== n || t && "function" == typeof t.moveTo || (n = t, t = null),
        n = null == n ? 2 : +n;
  ...
  function Qu(t) {
    ...
    return isNaN(t)
      ...
      : ((n = t.getUTCFullYear()) < 0 ? "-" + Ku(-n, 6) : n > 9999 ? "+" + Ku(n, 6) : Ku(n, 4)) +
        "-" + Ku(t.getUTCMonth() + 1, 2) + "-" + Ku(t.getUTCDate(), 2) + (o
  ...
  Fc.copy = function () {
    ...
    Fc.find = function (t, n, e) {
      ...
      for (
        ...
        if (
          !(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)
        ) {
          if (g.length) {
            var y = (i + a) / 2, v = (o + u) / 2;
            p.push(
    ...
    Fc.remove = function (t) {
      ...
      return (i = d.next) && delete d.next,
        r
          ...
          : n
          ? (i ? n[l] = i : delete n[l],
            (d = n[0] || n[1] || n[2] || n[3]) && d === (n[3] || n[2] || n[1] || n[0]) &&
            !d.length && (e ? e[h] = d : this._root = d),
            this)
          : (this._root = i, this);
    },
    ...
    Fc.visitAfter = function (t) {
      var n, e = [], r = [];
      for (
        this._root && e.push(new Cc(this._root, this._x0, this._y0, this._x1, this._y1));
        n = e.pop();
      ) {
        var i = n.node;
        if (i.length) {
  ...
  function cf(t) {
    var n,
      e,
      r = void 0 === t.grouping || void 0 === t.thousands
        ? rf
        : (n = af.call(t.grouping, Number), e = t.thousands + "", function (t, r) {
          for (
  ...
  function Us(t, n) {
    ...
    if (es) {
      ...
      f ^ (u * Jf < c && c < u * t)
        ...
        : (n < Zf && (Zf = n), n > Qf && (Qf = n)),
        f
          ? t < Jf ? js(Wf, t) > js(Wf, Kf) && (Kf = t) : js(t, Kf) > js(Wf, Kf) && (Wf = t)
          : Kf >= Wf
          ? (t < Wf && (Wf = t), t > Kf && (Kf = t))
          : t > Jf
  ...
  function sl(t, n) {
    var e = Tf(t), r = Cf(t), i = Tf(n), o = Cf(n);
    function a(t, n) {
      var a = Tf(n), u = Tf(t) * a, c = Cf(t) * a, f = Cf(n), s = f * e + u * r;
      return [Mf(c * i - s * o, u * e - f * r), Rf(s * i + c * o)];
    }
    return a.invert = function (t, n) {
      var a = Tf(n), u = Tf(t) * a, c = Cf(t) * a, f = Cf(n), s = f * i - c * o;
  ...
  function ml(t, n) {
    var e = bl(n), r = n[1], i = Cf(r), o = [Cf(e), -Tf(e), 0], a = 0, u = 0, c = new T();
      ...
      var o,
        ...
        h = {
          ...
          polygonEnd: function () {
            ...
            var t = ml(o, r);
            a.length ? (l || (i.polygonStart(), l = !0), vl(a, Ml, t, e, i)) : t &&
              (l || (i.polygonStart(), l = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
              l && (i.polygonEnd(), l = !1),
              a = o = null;
          },
          sphere: function () {
  ...
  function Ml(t, n) {
    return ((t = t.x)[0] < 0 ? t[1] - yf - df : yf - t[1]) -
  ...
  function Al(t) {
    var n = Tf(t), e = 2 * mf, r = n > 0, i = xf(n) > df;
    function o(t, e) {
      return Tf(t) * Tf(e) > n;
    }
    function a(t, e, r) {
      var i = [1, 0, 0], o = ys(ps(t), ps(e)), a = gs(o, o), u = o[0], c = a - u * u;
      if (!c) return !r && t;
      ...
      if (!(y < 0)) {
        ...
        if (
          !A && M < w && (b = w, w = M, M = b),
            A || T < df
              ? A ? w + M > 0 ^ _[1] < (xf(_[0] - m) < df ? w : M) : w <= _[1] && _[1] <= M
              : T > gf ^ (m <= _[0] && _[0] <= x)
        ) {
          var S = _s(d, (-p + v) / g);
  ...
  function Kl() {
    ...
    function _() {
      return lt(Af(r / p) * p, e, p).map(s).concat(lt(Af(u / g) * g, a, g).map(l)).concat(
        lt(Af(n / h) * h, t, h).filter(function (t) {
          return xf(t % p) > df;
        }).map(c),
      ).concat(
        lt(Af(o / d) * d, i, d).filter(function (t) {
          return xf(t % g) > df;
        }).map(f),
      );
    }
    return v.lines = function () {
      ...
      v.extentMajor([[-180, -90 + df], [180, 90 - df]]).extentMinor([[-180, -80 - df], [
        180,
        80 + df,
      ]]);
  }
  ...
  function Dh(t, n) {
    var e = t - _h, r = n - bh, i = zf(e * e + r * r);
        ...
        function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
          ...
          if (b > 4 * n && g--) {
            var m = a + h,
              ...
              C = N - i,
              P = _ * k - v * C;
            (P * P / b > n || xf((v * k + _ * C) / b - .5) > .3 || a * h + u * d + c * p < hd) &&
  ...
  function vd(t) {
    ...
    function k() {
      var t = gd(l, 0, 0, m, x, b).apply(null, n(p, g)), r = gd(l, h - t[0], d - t[1], m, x, b);
    ...
    return E.stream = function (t) {
      ...
      E.rotate = function (t) {
        return arguments.length
          ? (y = t[0] % 360 * mf, v = t[1] % 360 * mf, _ = t.length > 2 ? t[2] % 360 * mf : 0, k())
          : [y * bf, v * bf, _ * bf];
      },
      E.angle = function (t) {
  ...
  function xd() {
    return md().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([
      -.6,
      38.7,
    ]);
  }
  function wd(t) {
    return function (n, e) {
      var r = Tf(n), i = Tf(e), o = t(r * i);
      return o === 1 / 0 ? [2, 0] : [o * i * Cf(n), o * Cf(e)];
    };
  }
  function Md(t) {
    return function (n, e) {
      var r = zf(n * n + e * e), i = t(r), o = Cf(i), a = Tf(i);
  ...
  function Ed(t) {
    ...
    function s() {
      var o = gf * a(), u = i(ll(i.rotate()).invert([0, 0]));
      return c(
        null == f
  ...
  function kd(t, n) {
    ...
    return o.invert = function (t, n) {
      var e = i - n, o = Pf(r) * zf(t * t + e * e), a = Mf(t, xf(e)) * Pf(e);
  ...
  function Pd(t, n) {
    var e = Tf(t), r = t === n ? Cf(t) : (e - Tf(n)) / (n - t), i = e / r + t;
  ...
  function qd(t, n) {
    var e = Rf(Fd * Cf(n)), r = e * e, i = r * r * r;
    return [
  ...
  qd.invert = function (t, n) {
    for (
      ...
      a < 12 &&
      (o = (i = (r -= e = (r * (zd + $d * i + o * (Dd + Rd * i)) - n) /
        (zd + 3 * $d * i + o * (7 * Dd + 9 * Rd * i))) * r) * i * i,
        !(xf(e) < pf));
      ++a
    );
    ...
    Id.invert = function (t, n) {
      ...
      do {
        var o = r * r, a = o * o;
        r -= e = (r * (1.007226 + o * (.015085 + a * (.028874 * o - .044475 - .005916 * a))) - n) /
          (1.007226 + o * (.045255 + a * (.259866 * o - .311325 - .005916 * 11 * a)));
      } while (xf(e) > df && --i > 0);
      return [
  ...
  function cp(t, n) {
    ...
    for (e = 0; e < t.length - 1; ++e) {
      for (r = e + 1; r < t.length; ++r) {
        if (
          fp(dp(t[e], t[r]), n) && fp(dp(t[e], n), t[r]) && fp(dp(t[r], n), t[e]) &&
          lp(pp(t[e], t[r], n), t)
        ) return [t[e], t[r], n];
      }
    }
      ...
      if ((a = t._squarify) && a.ratio === n) {
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h;) {
          ...
          u.dice
            ...
            : Ip(u, e, r, d ? e += (i - e) * u.value / d : i, o), d -= u.value;
        }
  ...
  var Gp = Math.random,
    ...
    Wp = function t(n) {
      function e(t, e) {
        return arguments.length < 2 && (e = t, t = 0),
          t = Math.floor(t),
          e = Math.floor(e) - t,
          function () {
      ...
      function r(t, r) {
        ...
        return function () {
          do {
            ...
            c >= 1 - .0331 * t * t * t * t && Math.log(c) >= .5 * t * t + i * (1 - u + Math.log(u))
          );
          return i * u * a() * r;
        };
      }
    ...
    ag = function t(n) {
      var e = rg.source(n), r = og.source(n);
      function i(t, n) {
        return t = +t,
    ...
    ug = function t(n) {
      function e(t, e, r) {
        var i;
        return 0 == (t = +t) ? i = (t) => -Math.log(t) : (t = 1 / t, i = (n) => Math.pow(n, t)),
          e = null == e ? 0 : +e,
          r = null == r ? 1 : +r,
          function () {
    ...
    sg = function t(n) {
      var e = ig.source(n), r = ag.source(n);
      function i(t) {
        return function () {
  ...
  function Eg(n, e, r, i) {
    ...
    switch ((i = Jc(null == i ? ",f" : i)).type) {
      ...
      case "p":
      case "r":
        null != i.precision || isNaN(o = hf(a, Math.max(Math.abs(n), Math.abs(e)))) ||
  ...
  function Fg(n) {
    const e = n(Cg, Pg), r = e.domain;
    let i, o, a = 10;
    function u() {
      return i = function (t) {
        return t === Math.E ? Math.log : 10 === t && Math.log10 || 2 === t && Math.log2 ||
    ...
    return e.base = function (t) {
      ...
      e.nice = () =>
        r(kg(r(), { floor: (t) => o(Math.floor(i(t))), ceil: (t) => o(Math.ceil(i(t))) })),
      e;
  }
  function qg(t) {
    return function (n) {
  ...
  function Lg(t) {
    ...
    return n.exponent = function (n) {
      return arguments.length
        ? 1 === (e = +n) ? t(mg, mg) : .5 === e ? t(Bg, Yg) : t(Og(e), Og(1 / e))
        : e;
    },
      Ng(n);
  }
  ...
  function Vg(t, n, e, r) {
    ...
    return i.floor = (n) => (t(n = new Date(+n)), n),
      i.ceil = (e) => (t(e = new Date(e - 1)), n(e, 1), t(e), e),
      i.round = (t) => {
        const n = i(t), e = i.ceil(t);
        return t - n < e - t ? n : e;
      },
  ...
  function iv(t, n, e, i, o, a) {
    ...
    function c(n, e, i) {
      const o = Math.abs(e - n) / i, a = r(([, , t]) => t).right(u, o);
  ...
  function I_(t, n, e, r, i, o, a, u, c, f) {
    ...
    return s.invert = function (t) {
      ...
      s.nice = function (t) {
        var e = h();
        return t && "function" == typeof t.range ||
  ...
  function O_() {
    ...
    function f(n) {
      return null == n || isNaN(n = +n)
        ? i
        : u(0 === e ? .5 : (n = (r(n) - t) * e, c ? Math.max(0, Math.min(1, n)) : n));
    }
    function s(t) {
      return function (n) {
        var e, r;
  ...
  function B_(t, n) {
    return n.domain(t.domain()).interpolator(t.interpolator()).clamp(t.clamp()).unknown(
      t.unknown(),
    );
  }
  function Y_() {
  ...
  function Ym(t, n) {
    var e = ym(!0), r = null, i = Im, o = null, a = km(u);
    function u(u) {
  ...
  function Lm(t, n, e) {
    var r = null, i = ym(!0), o = null, a = Im, u = null, c = km(f);
    function f(f) {
  ...
  function Km() {
    var t = Lm().curve(Xm), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    return t.angle = t.x,
      delete t.x,
      t.startAngle = t.x0,
      delete t.x0,
  ...
  function ax(t) {
    let n = ix, e = ox, r = Om, i = Bm, o = null, a = null, u = km(c);
    function c() {
      let c;
      const f = Fm.call(arguments), s = n.apply(this, f), l = e.apply(this, f);
      if (
        null == o && (a = t(c = u())),
          a.lineStart(),
          f[0] = s,
  ...
  var cx = {
      draw(t, n) {
        const e = .59436 * Mm(n + xm(n / 28, .75)), r = e / 2, i = r * ux;
        t.moveTo(0, e),
          t.lineTo(0, -e),
          t.moveTo(-i, -r),
          t.lineTo(i, r),
  ...
  var xx = {
    draw(t, n) {
      const e = Mm(.8908130915292852 * n), r = bx * e, i = mx * e;
  ...
  var Ax = {
    draw(t, n) {
      const e = .6824 * Mm(n), r = e / 2, i = e * Tx / 2;
  ...
  var Cx = {
      draw(t, n) {
        const e = Mm(n / kx), r = e / 2, i = e * Nx, o = r, a = e * Nx + e, u = -o, c = a;
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
    ...
    fw.prototype = {
      ...
      lineEnd: function () {
        ...
        if (e) {
          ...
          else {for (var r = sw(t), i = sw(n), o = 0, a = 1; a < e; ++o, ++a) {
  ...
  Tw.prototype = ww.prototype,
    ...
    t.arc = function () {
      var t = Cm, n = Pm, e = ym(0), r = null, i = zm, o = $m, a = Dm, u = null, c = km(f);
      function f() {
        var f,
          s,
          ...
          if (g > Em - Tm) {
            ...
            if (S > Tm) {
              ...
              (M -= 2 * C) > Tm ? (x += C *= y ? 1 : -1, w -= C) : (M = 0, x = w = (d + p) / 2),
                (T -= 2 * P) > Tm ? (b += P *= y ? 1 : -1, m -= P) : (T = 0, b = m = (d + p) / 2);
            }
    ...
    t.contourDensity = function () {
      var t = fu,
        ...
        s = Qa(20);
      function h(r) {
        var i = new Float32Array(c * f), s = Math.pow(2, -a), h = -1;
        for (const o of r) {
      ...
      function d(t) {
        var n = h(t), e = s(n), r = Math.pow(2, 2 * a);
        return Array.isArray(e) || (e = G(Number.MIN_VALUE, J(n) / r, e)),
          iu().size([c, f]).thresholds(e.map((t) => t * r))(n).map(
            (t, n) => (t.value = +e[n], p(t)),
          );
      }
      function p(t) {
    ...
    t.disjoint = function (t, n) {
      const e = n[Symbol.iterator](), r = new InternSet();
      for (const n of t) {
        if (r.has(n)) return !1;
        let t, i;
    ...
    t.drag = function () {
      var t,
        ...
        l = 0;
      function h(t) {
        t.on("mousedown.drag", d).filter(u).on("touchstart.drag", y).on("touchmove.drag", v, ee).on(
    ...
    t.geoAlbersUsa = function () {
      ...
      return s.invert = function (t) {
        ...
        s.scale = function (t) {
          return arguments.length
            ? (a.scale(t), u.scale(.35 * t), c.scale(t), s.translate(a.translate()))
            : a.scale();
        },
        s.translate = function (t) {
          if (!arguments.length) return a.translate();
          var n = a.scale(), o = +t[0], s = +t[1];
          return e = a.translate(t).clipExtent([[o - .455 * n, s - .238 * n], [
            o + .455 * n,
            s + .238 * n,
          ]]).stream(f),
            r = u.translate([o - .307 * n, s + .201 * n]).clipExtent([[
              o - .425 * n + df,
              s + .12 * n + df,
            ], [o - .214 * n - df, s + .234 * n - df]]).stream(f),
            i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([[
              o - .214 * n + df,
              s + .166 * n + df,
            ], [o - .115 * n - df, s + .234 * n - df]]).stream(f),
            l();
        },
    ...
    t.geoPath = function (t, n) {
      ...
      function a(t) {
        return t &&
          ("function" == typeof o && r.pointRadius(+o.apply(this, arguments)), Lf(t, e(r))),
          r.result();
      }
    ...
    t.geoTransverseMercator = function () {
      var t = Ed(Yd), n = t.center, e = t.rotate;
    ...
    t.groupSort = function (t, e, r) {
      return (2 !== e.length
        ...
        : U(C(t, r), ([t, r], [i, o]) => e(r, o) || n(t, i))).map(([t]) => t);
    },
    t.groups = P,
    t.hcl = dr,
    t.hierarchy = Gd,
    ...
    t.now = Ai,
    t.pack = function () {
      var t = null, n = 1, e = 1, r = np;
      function i(i) {
        const o = ap();
        return i.x = n / 2,
          i.y = e / 2,
          t
            ? i.eachBefore(xp(t)).eachAfter(wp(r, .5, o)).eachBefore(Mp(1))
            : i.eachBefore(xp(mp)).eachAfter(wp(np, 1, o)).eachAfter(wp(r, i.r / Math.min(n, e), o))
    ...
    t.permute = q,
    t.pie = function () {
      var t = Hm, n = jm, e = null, r = ym(0), i = ym(Em), o = ym(0);
      function a(a) {
        var u,
          c,
          f,
    ...
    t.pointers = function (t, n) {
      return t.target && (t = te(t), void 0 === n && (n = t.currentTarget), t = t.touches || [t]),
    ...
    t.treemap = function () {
      var t = Yp, n = !1, e = 1, r = 1, i = [0], o = np, a = np, u = np, c = np, f = np;
      function s(t) {
        return t.x0 = t.y0 = 0,
          t.x1 = e,
          t.y1 = r,
    ...
    t.zoom = function () {
      var t,
        ...
        y = 10;
      function v(t) {
        t.property("__zoom", kw).on("wheel.zoom", T, { passive: !1 }).on("mousedown.zoom", A).on(
          "dblclick.zoom",
          S,
        ).filter(u).on("touchstart.zoom", E).on("touchmove.zoom", N).on(
      ...
      function T(t, ...n) {
        if (r.apply(this, arguments)) {
          ...
          if (e.wheel) {
            ...
            (e.mouse[1] = i.invert(e.mouse[0] = s)), clearTimeout(e.wheel);
          } else {
            if (i.k === u) return;
      ...
      function k(t, ...r) {
        if (this.__zooming) {
          ...
          if (a.touch1 && !a.touch0 && (a.touch0 = a.touch1, delete a.touch1), a.touch0) {
            ...
            a.end(), 2 === a.taps && (o = ne(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < y)
          ) {
      ...
      return v.transform = function (t, n, e, r) {
        ...
        i.property("__zoom", kw),
          t !== i ? x(t, n, e, r) : i.interrupt().each(function () {
            w(this, arguments).event(r).start().zoom(
              null,
        ...
        v.translateTo = function (t, n, e, r, a) {
          v.transform(
            ...
            function () {
              ...
              return o(
                Mw.translate(u[0], u[1]).scale(a.k).translate(
                  "function" == typeof n ? -n.apply(this, arguments) : -n,
                  "function" == typeof e ? -e.apply(this, arguments) : -e,
                ),
                t,
        ...
        v.extent = function (t) {
          return arguments.length
            ? (i = "function" == typeof t ? t : mw([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), v)
            : i;
        },
