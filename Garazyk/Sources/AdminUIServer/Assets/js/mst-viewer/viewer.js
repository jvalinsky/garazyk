  ...
  renderAccountList() {
    ...
    if (filteredAccounts.length === 0) {
      this.accountListEl.innerHTML =
        '<li class="placeholder placeholder-list-item">No accounts found</li>';
      return;
    }
    ...
    this.accountListEl.innerHTML = filteredAccounts
      .map((account) => `
                <li class="account-item ${this.currentAccount === account.did ? "active" : ""}"
                    ...
                    <div class="account-item-did">${
        this.escapeHtml(account.did.substring(0, 30))
      }...</div>
                </li>
            `)
      .join("");
