...
/*!
 @file GZPerDidWriteDispatcher.h
 ...
 */
typedef void (^GZWriteBlock)(void);

/*!
 @class GZPerDidWriteDispatcher
 ...
 Usage:
 @code
 GZPerDidWriteDispatcher *dispatcher = [[GZPerDidWriteDispatcher alloc]
 ...
 */
/**
 * @abstract Declares the GZPerDidWriteDispatcher public API.
 */
@interface GZPerDidWriteDispatcher : NSObject
