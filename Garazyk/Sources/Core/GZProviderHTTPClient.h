...
extern NSString *const GZProviderHTTPClientErrorDomain;

/*!

 @abstract Error codes for provider HTTP client operations.
 */
typedef NS_ENUM(NSInteger, GZProviderHTTPClientErrorCode) {
    GZProviderHTTPClientErrorSerializationFailed = 1,
    GZProviderHTTPClientErrorRequestFailed = 2,
    GZProviderHTTPClientErrorHTTPError = 3,
    GZProviderHTTPClientErrorMaxRetriesExceeded = 4,
};

/*!
 @class GZProviderHTTPClient
 ...
 */
@interface GZProviderHTTPClient : NSObject
