...
extern NSString * const kPDSBlobRefTableName;
...
extern NSString * const kPDSBlobRefTableCreateSQL;
...
extern NSString * const kPDSIndexBlocksRepoDidCreatedSQL;
extern NSString * const kPDSIndexBlobsDidSQL;
extern NSString * const kPDSIndexBlobsDidCreatedSQL;
...
extern NSString * const kPDSIndexTakedownsAppliedSQL;
...
extern NSString * const kPDSIndexLabelsValSQL;
extern NSString * const kPDSIndexLabelsSrcValSQL;
