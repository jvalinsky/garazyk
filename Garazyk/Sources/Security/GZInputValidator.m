...
NSErrorDomain const GZValidationErrorDomain = @"com.atproto.pds.validation";

static const char kTIDBase32Alphabet[] = "234567abcdefghijklmnopqrstuvwxyz";

@interface GZInputValidator ()
...
@implementation GZInputValidator

+ (instancetype)sharedValidator {
    static GZInputValidator *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[GZInputValidator alloc] init];
    });
    return instance;
}
