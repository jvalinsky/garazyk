...
/*!
 @file ATProtoXRPCError.h

 @abstract Error types for XRPC client-side error handling.

 @discussion Provides ATProtoXRPCError class for parsing error responses from
 ...
 */
@interface ATProtoXRPCError : NSObject
...
/*!
 ...
 @abstract Creates an ATProtoXRPCError from JSON data.
 ...
 @return A new ATProtoXRPCError instance, or nil if parsing fails.
 */
...
/*!
 ...
 @abstract Creates an ATProtoXRPCError from a dictionary.
...
/*!
 ...
 @abstract Initializes an ATProtoXRPCError with the given values.

 @param error The error code string.
 @param message The detailed error message.
 @param statusCode The HTTP status code.

 @return A new ATProtoXRPCError instance.
 */
/**
...
/*!
 ...
 @abstract Converts the ATProtoXRPCError to an NSError.

 @return An NSError with the ATProtoXRPCError domain and appropriate userInfo.
 */
- (NSError *)toNSError;
