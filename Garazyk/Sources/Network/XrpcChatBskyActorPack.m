...
+ (void)registerWithDispatcher:(XrpcDispatcher *)dispatcher
  ...
  // chat.bsky.actor.declaration is a record type (not a query). Clients access
  // it via com.atproto.repo.getRecord?collection=chat.bsky.actor.declaration.
  // The phantom query endpoint was removed because the lexicon declares this NSID
  // as type "record", and registering it as a query violates verb contracts.
