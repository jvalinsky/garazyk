 ...
 * primary plc.directory instance.
 */
...
/**
 * @abstract Designated initializer for the replica server.
 * @param store The local PLC store.
 * @param auditor The PLC auditor instance.
 * @param port The HTTP listening port.
