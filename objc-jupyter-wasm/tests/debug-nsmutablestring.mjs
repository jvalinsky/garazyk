...
// Test 1: NSMutableString creation
console.log("=== Test 1: NSMutableString creation ===");
let r = execute(`NSMutableString *ms = [NSMutableString stringWithString:@"hello"];
NSLog(@"%@", ms);`);
...
// Test 2: appendString
console.log("\n=== Test 2: appendString ===");
r = execute(`NSMutableString *ms = [NSMutableString stringWithString:@"hello"];
