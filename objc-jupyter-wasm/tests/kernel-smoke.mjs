...
const combinedTest = execute(
  'int d = (1 > 0) && (2 < 3); NSLog(@"(1>0)&&(2<3)=%d", d);',
  "combined-test",
);
...
const ifElseTest = execute(
  'if (0) { NSLog(@"skip"); } else { NSLog(@"else-branch"); }',
  "if-else-cell",
);
...
const ifLogicTest = execute(
  'int x = 5; if (x > 0 && x < 10) { NSLog(@"in-range"); }',
  "if-logic-cell",
);
...
// YES/NO in condition
const boolCondTest = execute(
  'if (YES) { NSLog(@"yes-true"); } if (!NO) { NSLog(@"no-false"); }',
  "bool-cond-cell",
);
...
{
  const r = execute(
    'NSDictionary *d = @{@"k": @[@"a", @"b"]}; [[d objectForKey:@"k"] count]',
    "nested-literal",
  );
  assert.equal(r.status, "ok");
...

{
  ...
  const gcObjSetCell = execute(
    "PropCounter *gcCounter = [[PropCounter alloc] init]; [gcCounter setCount:42];",
    "gc-obj-set",
  );
...
// Ternary operator
{
  const ternary1 = execute(
    'int x = 5; int y = x > 3 ? 10 : 20; NSLog(@"ternary=%d", y);',
    "ternary-1",
  );
...

{
  ...
  const defCalc = execute(
    "@interface CalcRet\n- (int)add:(int)a to:(int)b;\n@end\n\n@implementation CalcRet\n- (int)add:(int)a to:(int)b {\n    return a + b;\n}\n@end",
    "calc-def",
  );
  assert.equal(defCalc.status, "ok");

  const useCalc = execute(
    'CalcRet *cr = [[CalcRet alloc] init]; int r = [cr add:3 to:4]; NSLog(@"3+4=%d", r);',
    "calc-use",
  );
  ...
  const exprResult = execute(
    "CalcRet *cr2 = [[CalcRet alloc] init]; [cr2 add:10 to:20];",
    "expr-result",
  );
...

{
  ...
  const arr1 = execute(
    'NSMutableArray *arr = [NSMutableArray array]; NSLog(@"empty=%d", [arr count]); [arr addObject:@"hello"]; [arr addObject:@"world"]; NSLog(@"count=%d", [arr count]); NSLog(@"[0]=%@", [arr objectAtIndex:0]); NSLog(@"last=%@", [arr lastObject]);',
    "arr-basic",
  );
  ...
  const arr2 = execute(
    'NSMutableArray *arr2 = [NSMutableArray array]; [arr2 addObject:@"a"]; [arr2 addObject:@"b"]; [arr2 addObject:@"c"]; [arr2 removeLastObject]; NSLog(@"after remove: count=%d last=%@", [arr2 count], [arr2 lastObject]); [arr2 removeAllObjects]; NSLog(@"after clear: count=%d", [arr2 count]);',
    "arr-remove",
  );
  ...
  const dict1 = execute(
    'NSMutableDictionary *dict = [NSMutableDictionary dictionary]; [dict setObject:@"value1" forKey:@"key1"]; [dict setObject:@"value2" forKey:@"key2"]; NSLog(@"count=%d", [dict count]); NSLog(@"key1=%@", [dict objectForKey:@"key1"]); NSLog(@"missing=%@", [dict objectForKey:@"nope"]);',
    "dict-basic",
  );
  ...
  const dict2 = execute(
    'NSMutableDictionary *d = [NSMutableDictionary dictionary]; [d setObject:@"v" forKey:@"k"]; NSLog(@"before=%d", [d count]); [d removeObjectForKey:@"k"]; NSLog(@"after=%d", [d count]);',
    "dict-remove",
  );
  ...
  const dict3 = execute(
    'NSMutableDictionary *d = [NSMutableDictionary dictionary]; [d setObject:@"hello" forKey:@"greeting"]; NSLog(@"greeting=%@", [d objectForKey:@"greeting"]);',
    "dict-kv",
  );
  ...
  const forinArr = execute(
    'NSMutableArray *arr = [NSMutableArray array]; [arr addObject:@"x"]; [arr addObject:@"y"]; [arr addObject:@"z"]; for (NSString *s in arr) { NSLog(@"item=%@", s); }',
    "forin-arr",
  );
  ...
  const forinDict = execute(
    'NSMutableDictionary *d = [NSMutableDictionary dictionary]; [d setObject:@"apple" forKey:@"fruit"]; [d setObject:@"carrot" forKey:@"veg"]; for (NSString *k in d) { NSLog(@"%@=%@", k, [d objectForKey:k]); }',
    "forin-dict",
  );
  ...
  const set1 = execute(
    'NSMutableArray *src = [NSMutableArray array]; [src addObject:@"a"]; [src addObject:@"b"]; [src addObject:@"a"]; NSSet *set = [NSSet setWithArray:src]; NSLog(@"set count=%d", [set count]); NSLog(@"has a=%d", [set containsObject:@"a"]); NSLog(@"has c=%d", [set containsObject:@"c"]);',
    "set-basic",
  );
  ...
  const keysVals = execute(
    'NSMutableDictionary *d = [NSMutableDictionary dictionary]; [d setObject:@"1" forKey:@"a"]; [d setObject:@"2" forKey:@"b"]; NSArray *keys = [d allKeys]; NSArray *vals = [d allValues]; NSLog(@"keys=%d vals=%d", [keys count], [vals count]);',
    "keys-vals",
  );
  ...
  const allocInit = execute(
    'NSMutableArray *arr = [[NSMutableArray alloc] init]; [arr addObject:@"item"]; NSLog(@"alloc-init: count=%d %@", [arr count], [arr objectAtIndex:0]);',
    "alloc-init",
  );
  ...
  const numKey = execute(
    'NSMutableDictionary *d = [NSMutableDictionary dictionary]; NSNumber *key = [NSNumber numberWithInt:42]; [d setObject:@"found" forKey:key]; NSLog(@"numkey=%@", [d objectForKey:key]);',
    "numkey",
  );
  ...
  const crossCell1 = execute(
    'NSMutableDictionary *globalDict = [NSMutableDictionary dictionary]; [globalDict setObject:@"persistent" forKey:@"data"];',
    "cross1",
  );
  ...
  const countExpr = execute(
    'NSMutableArray *a = [NSMutableArray array]; [a addObject:@"x"]; [a addObject:@"y"]; [a count];',
    "count-expr",
  );
...
// Float + int promotion
const floatIntPromoTest = execute(
  'double y = 3.14 + 1; NSLog(@"y = %f", y);',
  "float-int-promo-cell",
);
...
// Float comparison
const floatCmpTest = execute(
  'int cmp = 3.14 > 2.71; NSLog(@"3.14>2.71 = %d", cmp);',
  "float-cmp-cell",
);
...
const floatCompoundTest = execute(
  'double a = 1.5; a += 0.5; NSLog(@"a = %f", a);',
  "float-compound-cell",
);
...
console.log(
  "  floats: literal, arithmetic, promotion, comparison, NSNumber, compound, unary — PASS",
);
...
// substringFromIndex:
const subFromTest = execute(
  'NSString *s = @"Hello World"; NSString *sub = [s substringFromIndex:6]; NSLog(@"%s", [sub UTF8String]);',
  "sub-from-cell",
);
...
// substringToIndex:
const subToTest = execute(
  'NSString *s = @"Hello World"; NSString *sub = [s substringToIndex:5]; NSLog(@"%s", [sub UTF8String]);',
  "sub-to-cell",
);
...
// characterAtIndex:
const charAtTest = execute(
  'NSString *s = @"ABC"; int c = [s characterAtIndex:1]; NSLog(@"c = %d", c);',
  "char-at-cell",
);
...
// hasPrefix: / hasSuffix:
const prefixTest = execute(
  'NSString *s = @"Hello World"; int hp = [s hasPrefix:@"Hello"]; int hs = [s hasSuffix:@"World"]; NSLog(@"hp=%d hs=%d", hp, hs);',
  "prefix-cell",
);
...
const caseTest = execute(
  'NSString *s = @"Hello"; NSLog(@"upper=%s lower=%s", [[s uppercaseString] UTF8String], [[s lowercaseString] UTF8String]);',
  "case-cell",
);
...
console.log(
  "  NSString: substringFromIndex, substringToIndex, characterAtIndex, hasPrefix, hasSuffix, upper/lower — PASS",
);

// ── Phase 15: Additional Foundation method tests ──────────────────

// stringByReplacingOccurrencesOfString:withString:
const replaceTest = execute(
  'NSString *s = @"hello world hello"; NSString *r = [s stringByReplacingOccurrencesOfString:@"hello" withString:@"hi"]; NSLog(@"%s", [r UTF8String]);',
  "replace-cell",
);
...
const splitTest = execute(
  'NSString *s = @"a,b,c"; NSArray *parts = [s componentsSeparatedByString:@","]; NSLog(@"count=%d", [parts count]);',
  "split-cell",
);
...
const trimTest = execute(
  'NSString *s = @"  hello  "; NSString *t = [s stringByTrimmingWhitespace]; NSLog(@"[%s]", [t UTF8String]);',
  "trim-cell",
);
...
const boolNumTest = execute(
  'NSNumber *yesNum = [NSNumber numberWithBool:YES]; NSNumber *noNum = [NSNumber numberWithBool:NO]; NSLog(@"yes=%d no=%d", [yesNum boolValue], [noNum boolValue]);',
  "boolnum-cell",
);
...
const strValTest = execute(
  'NSNumber *n = [NSNumber numberWithInt:42]; NSString *s = [n stringValue]; NSLog(@"s=%s", [s UTF8String]);',
  "strval-cell",
);
...
// NSNumber longValue
const longValTest = execute(
  'NSNumber *n = [NSNumber numberWithInt:123]; int lv = [n longValue]; NSLog(@"long=%d", lv);',
  "longval-cell",
);
...
const dictObjTest = execute(
  'NSDictionary *d = [NSDictionary dictionaryWithObject:@"value" forKey:@"key"]; NSLog(@"val=%s", [[d objectForKey:@"key"] UTF8String]);',
  "dictobj-cell",
);
...
const emptyDataTest = execute(
  'NSData *d = [NSData data]; NSLog(@"len=%d", [d length]);',
  "empty-data-cell",
);
...
const dataTest = execute(
  'NSData *d = [NSData dataWithBytes:@"ABC" length:3]; NSLog(@"len=%d", [d length]);',
  "data-cell",
);
...
const dataBytesTest = execute(
  'NSData *d = [NSData dataWithBytes:@"Hi" length:2]; NSString *b = [d bytes]; NSLog(@"len=%d", [b length]);',
  "bytes-cell",
);
...
const dataDescTest = execute(
  'NSData *d = [NSData dataWithBytes:@"AB" length:2]; NSLog(@"desc=%@", d);',
  "datadesc-cell",
);
...
console.log(
  "  Foundation: stringByReplacing, componentsSeparated, trim, numberWithBool, stringValue, longValue, dictionaryWithObject, isEqualToDictionary, NSData — PASS",
);
...
// @-keyword completion
{
  ...
  assert.equal(r.status, "ok");
  assert.ok(
    r.matches.includes("@interface"),
    `@int should complete to @interface, got: ${JSON.stringify(r.matches)}`,
  );
...
// @-keyword completion: @imp
{
  ...
  assert.equal(r.status, "ok");
  assert.ok(
    r.matches.includes("@implementation"),
    `@imp should complete to @implementation, got: ${JSON.stringify(r.matches)}`,
  );
}
...
// Class name completion
{
  ...
  assert.equal(r.status, "ok");
  assert.ok(
    r.matches.includes("NSString"),
    `NSS should complete to NSString, got: ${JSON.stringify(r.matches)}`,
  );
  assert.ok(
    r.matches.includes("NSSet"),
    `NSS should complete to NSSet, got: ${JSON.stringify(r.matches)}`,
  );
}
...
// Selector completion inside message send
{
  ...
  assert.equal(r.status, "ok");
  assert.ok(
    r.matches.includes("substringFromIndex:"),
    `[str sub should complete to substringFromIndex:, got: ${JSON.stringify(r.matches)}`,
  );
  assert.ok(
    r.matches.includes("substringToIndex:"),
    `[str sub should complete to substringToIndex:, got: ${JSON.stringify(r.matches)}`,
  );
}
...
// Variable name completion (after executing code that defines variables)
{
  ...
  assert.equal(r.status, "ok");
  assert.ok(
    r.matches.includes("myCounter"),
    `myCo should complete to myCounter, got: ${JSON.stringify(r.matches)}`,
  );
}
...
// No prefix — returns all class names and type keywords
{
  ...
  assert.ok(
    r.matches.includes("NSObject"),
    `empty prefix should include NSObject, got: ${JSON.stringify(r.matches)}`,
  );
  assert.ok(
    r.matches.includes("int"),
    `empty prefix should include int, got: ${JSON.stringify(r.matches)}`,
  );
}
...
// Syntax error should include line/column in error message
{
  ...
  assert.ok(
    /line \d+, column \d+:/.test(r.evalue),
    `error message should include line/column, got: ${r.evalue}`,
  );
  // Traceback should have entries
  assert.ok(Array.isArray(r.traceback), "traceback should be an array");
  assert.ok(
    r.traceback.length >= 1,
    `traceback should have at least 1 entry, got ${r.traceback.length}`,
  );
  // First traceback entry should mention the cell and line
  assert.ok(
    r.traceback[0].includes("Cell In[") || r.traceback[0].includes("line"),
...
// Multi-line error: error on second line
{
  ...
  assert.ok(
    /line \d+, column \d+:/.test(r.evalue),
    `error should include line/column, got: ${r.evalue}`,
  );
  // Traceback should include the source line
  assert.ok(
    r.traceback.length >= 2,
    `traceback should have at least 2 entries, got ${r.traceback.length}`,
  );
  if (r.traceback.length >= 2) {
    assert.ok(
      r.traceback[1].includes("int b"),
      `second traceback entry should include the source line, got: ${r.traceback[1]}`,
    );
  }
}
...
{
  execute(
    'NSMutableArray *a = [NSMutableArray array]; [a addObject:@"zero"]; [a addObject:@"one"]; [a addObject:@"two"];',
    "replacearr-setup",
  );
  const r = execute(
    '[a replaceObjectAtIndex:1 withObject:@"ONE"]; NSLog(@"%d %@", [a count], [a objectAtIndex:1]);',
    "replacearr-test",
  );
  assert.equal(r.status, "ok");
...
{
  execute(
    'NSMutableArray *b = [NSMutableArray array]; [b addObject:@"a"]; [b addObject:@"c"];',
    "insertarr-setup",
  );
  const r = execute(
    '[b insertObject:@"b" atIndex:1]; NSLog(@"%d %@ %@ %@", [b count], [b objectAtIndex:0], [b objectAtIndex:1], [b objectAtIndex:2]);',
    "insertarr-test",
  );
  assert.equal(r.status, "ok");
...
{
  execute(
    'NSMutableArray *c = [NSMutableArray array]; [c addObject:@"x"]; [c addObject:@"y"]; [c addObject:@"z"];',
    "remarr-setup",
  );
  const r = execute(
    '[c removeObjectAtIndex:1]; NSLog(@"%d %@", [c count], [c objectAtIndex:1]);',
    "remarr-test",
  );
  assert.equal(r.status, "ok");
...
{
  execute(
    'NSMutableArray *d = [NSMutableArray array]; [d addObject:@"alpha"]; [d addObject:@"beta"]; [d addObject:@"gamma"];',
    "idxarr-setup",
  );
...
{
  execute(
    'NSMutableArray *e = [NSMutableArray array]; [e addObject:@"first"]; [e addObject:@"second"];',
    "sub-read-setup",
  );
...
{
  execute(
    'NSMutableDictionary *g = [NSMutableDictionary dictionary]; [g setObject:@"value1" forKey:@"k1"]; [g setObject:@"value2" forKey:@"k2"];',
    "dictsub-read-setup",
  );
...
{
  const r = execute(
    'int x = 2;\nswitch (x) { case 1: NSLog(@"one"); break; case 2: NSLog(@"two"); break; case 3: NSLog(@"three"); break; }',
    "switch-basic",
  );
  assert.equal(r.status, "ok");
  assert.match(hostStreamText(), /two/);
...
{
  const r = execute(
    'int y = 99;\nswitch (y) { case 1: NSLog(@"one"); break; default: NSLog(@"other"); break; }',
    "switch-default",
  );
  assert.equal(r.status, "ok");
...
{
  const r = execute(
    'int z = 1;\nswitch (z) { case 1: NSLog(@"one"); case 2: NSLog(@"two"); break; case 3: NSLog(@"three"); break; }',
    "switch-fallthrough",
  );
  assert.equal(r.status, "ok");
  assert.match(hostStreamText(), /one/);
...
{
  const r = execute(
    "int n = 0; do { n++; if (n >= 3) break; } while (n < 100); n",
    "do-while-break",
  );
  assert.equal(r.status, "ok");
  assert.match(r.data["text/plain"], /^3$/);
...
// continue in do/while
{
  hostStreams.length = 0;
  const r = execute(
    'int sum = 0; int j = 0; do { j++; if (j % 2 == 0) continue; sum += j; } while (j < 6); NSLog(@"sum=%d", sum);',
    "do-while-continue",
  );
  assert.equal(r.status, "ok");
...
{
  const classOnTagged = execute(
    "NSNumber *n = [NSNumber numberWithBool:YES]; [n class];",
    "tagged-class",
  );
...
{
  const chained = execute(
    'int a = 0; int b = 0; a = b = 5; NSLog(@"chain=%d/%d", a, b);',
    "chained-assign",
  );
...
{
  const nonIntCase = execute(
    'switch (1) { case 1.5: NSLog(@"bad"); break; }',
    "switch-non-int-case",
  );
...
{
  const fmtUnderrun = execute(
    'NSString *s = [NSString stringWithFormat:@"%d"]; NSLog(@"fmt=%@", s);',
    "format-underrun",
  );
...
{
  const splitResource = execute(
    'for (int i = 0; i < 200; i++) { NSString *s = @"abcd"; [s componentsSeparatedByString:@""]; }',
    "split-resource",
  );
...
{
  const pointerFormat = execute(
    'id obj = [NSString stringWithFormat:@"test"]; NSLog(@"ptr=%p", obj);',
    "pointer-format",
  );
