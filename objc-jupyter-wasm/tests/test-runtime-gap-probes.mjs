...
const probes = [
  ...
  {
    cat: "Class definition & inheritance",
    name: "Basic @interface + @implementation",
    code:
  ...
  {
    cat: "Class definition & inheritance",
    name: "Inheritance chain (3 levels)",
    code:
  ...
  {
    cat: "Protocols",
    name: "@protocol + conformsToProtocol:",
    code:
  ...
  {
    cat: "Properties",
    name: "Dot syntax on custom class",
    code:
  ...
  {
    cat: "Properties",
    name: "Custom @synthesize ivar name",
    code:
  ...
  {
    cat: "Blocks",
    name: "Block returning value",
    code: `int (^adder)(int, int) = ^(int a, int b) { return a + b; };\nNSLog(@"%d", adder(3, 4));`,
    expect: "7",
  },
  {
    cat: "Blocks",
    name: "Block capturing variable (by-value)",
    code: `int x = 10;\nint (^block)(void) = ^{ return x; };\nx = 20;\nNSLog(@"%d", block());`,
    expect: "10",
  },
  {
    cat: "Blocks",
    name: "__block variable mutation",
    code:
  ...
  },
  {
    ...
    expect: "should not reach",
    expectAbsent: true,
  },

  // ── Message forwarding ──────────────────────────────────────
  {
    cat: "Message forwarding",
  ...
  {
    cat: "KVC",
    name: "valueForKey: / setValue:forKey:",
    code:
      `@interface KV : NSObject\n@property NSString *name;\n@end\n@implementation KV @end\nKV *o = [KV new];\no.name = @"hello";\nNSLog(@"%@", [o valueForKey:@"name"]);`,
    expect: "hello",
  },
  {
    cat: "KVC",
    name: "KVC on dictionary",
  ...
  // ── Autorelease pool ────────────────────────────────────────
  {
    cat: "Autorelease pool",
    name: "@autoreleasepool basic",
    code: `@autoreleasepool {\n  NSString *s = @"test";\n  NSLog(@"%@", s);\n}`,
    expect: "test",
  },
  {
    cat: "Autorelease pool",
    name: "Nested autorelease pools",
    code:
      `@autoreleasepool {\n  @autoreleasepool {\n    NSLog(@"inner");\n  }\n  NSLog(@"outer");\n}`,
    expect: "inner",
  },
  {
    cat: "Autorelease pool",
    name: "[obj autorelease] returns self",
  ...
  {
    cat: "Categories",
    name: "Category on Foundation class",
    code:
  ...
  {
    cat: "nil messaging",
    name: "[nil anyMethod] returns nil/0",
    code: `id nothing = nil;\nint i = [nothing intValue];\nNSLog(@"%d", i);`,
    expect: "0",
  },
  {
    cat: "nil messaging",
    name: "[nil count] returns 0",
    code: `id n = nil;\nint c = [n count];\nNSLog(@"%d", c);`,
    expect: "0",
  },
  ...
  {
    cat: "Format strings",
    name: "stringWithFormat: %@ %d %f",
    code:
      `NSString *s = [NSString stringWithFormat:@"name=%@ count=%d pi=%f", @"test", 42, 3.14];\nNSLog(@"%@", s);`,
  ...
  // ── Collection operations ──────────────────────────────────
  {
    ...
    name: "NSArray literal + subscript",
    code: `NSArray *a = @[@"x", @"y", @"z"];\nNSLog(@"%@", a[1]);`,
    expect: "y",
  },
  {
    cat: "Collection operations",
    name: "NSDictionary literal + subscript",
    code: `NSDictionary *d = @{@"key": @"val"};\nNSLog(@"%@", d[@"key"]);`,
    expect: "val",
  },
  {
    cat: "Collection operations",
    name: "NSMutableArray subscript assignment",
    code:
  ...
  {
    cat: "Collection operations",
    name: "NSMutableDictionary subscript",
    code:
  ...
  {
    cat: "Collection operations",
    name: "Fast enumeration (for...in) on array",
    code:
  ...
  {
    cat: "Collection operations",
    name: "Fast enumeration on dictionary",
    code:
  ...
  {
    cat: "NSNumber boxing",
    name: "NSNumber equality",
    code:
      `NSNumber *a = [NSNumber numberWithInt:5];\nNSNumber *b = [NSNumber numberWithInt:5];\nNSLog(@"%d", [a isEqual:b]);`,
    expect: "1",
  },
  ...
  { cat: "Operators", name: "Unary minus", code: `int x = -5;\nNSLog(@"%d", x);`, expect: "-5" },
  {
    cat: "Operators",
  ...
  // ── Associated objects ──────────────────────────────────────
  {
    cat: "Associated objects",
    name: "objc_setAssociatedObject / objc_getAssociatedObject",
    code:
      `@interface Assoc : NSObject @end\n@implementation Assoc @end\nAssoc *obj = [Assoc new];\nstatic char key;\nobjc_setAssociatedObject(obj, &key, @"value", 1);\nNSLog(@"%@", objc_getAssociatedObject(obj, &key));`,
    expect: "value",
  },
  ...
  // ── Memory management ──────────────────────────────────────
  {
    ...
    name: "retain/release/autorelease no-ops",
    code: `NSString *s = @"hello";\n[s retain];\n[s release];\n[s autorelease];\nNSLog(@"ok");`,
    expect: "ok",
  },
  ...
  {
    cat: "@class forward declaration",
    name: "@class forward decl",
    code:
  ...
  // ── C array subscript ──────────────────────────────────────
  {
    cat: "C array subscript",
    name: "NSMutableArray subscript [idx]",
    code:
  ...
  // ── NSLog ──────────────────────────────────────────────────
  { cat: "NSLog", name: "NSLog basic format", code: `NSLog(@"hello %d", 42);`, expect: "hello 42" },
  {
    cat: "NSLog",
    name: "NSLog with object",
  ...
  // ── Crypto host bridge ──────────────────────────────────────
  {
    cat: "Crypto host bridge",
    name: "[CID sha256Digest:]",
    code:
      `NSData *input = [NSData dataWithBytes:"abc" length:3];\nNSData *hash = [CID sha256Digest:input];\nNSLog(@"%d", [hash length]);`,
    expect: "32",
  },
  ...
  {
    cat: "Tab completion",
    name: "Tab completion via bridge",
  ...
  {
    cat: "Runtime API",
    name: "sel_registerName / sel_getName",
    code:
      `SEL s = sel_registerName("count");\nconst char *name = sel_getName(s);\nNSLog(@"%s", name);`,
    expect: "count",
  },
  ...
  // ── @protocol() expression ─────────────────────────────────
  {
    cat: "@protocol() expression",
    name: "@protocol(Drawable) as argument",
  ...
  {
    cat: "instancetype",
    name: "instancetype return type",
    code:
      `@interface Inst : NSObject\n+ (instancetype)create;\n@end\n@implementation Inst\n+ (instancetype)create { return [[Inst alloc] init]; }\n@end\nInst *i = [Inst create];\nNSLog(@"%d", i != nil);`,
    expect: "1",
  },
  ...
  {
    cat: "Cross-cell persistence",
    name: "Class persists across cells",
  ...
  {
    cat: "NSData",
    name: "NSData dataWithBytes:length:",
    code: `NSData *d = [NSData dataWithBytes:"hello" length:5];\nNSLog(@"%d", [d length]);`,
    expect: "5",
  },
  {
    cat: "NSData",
    name: "NSData dataByAppendingData:",
    code:
      `NSData *a = [NSData dataWithBytes:"he" length:2];\nNSData *b = [NSData dataWithBytes:"llo" length:3];\nNSData *c = [a dataByAppendingData:b];\nNSLog(@"%d", [c length]);`,
    expect: "5",
  },
  {
    cat: "NSData",
    name: "NSMutableData creation and length",
    code:
  ...
  {
    cat: "Collections",
    name: "NSMutableSet addObject and containsObject",
    code:
  ...
  {
    cat: "Parser",
    name: "unsigned char array initializer",
    code: `unsigned char bytes[2] = {216, 42};\nNSLog(@"%d", [bytes length]);`,
    expect: "2",
  },
  {
    cat: "Parser",
    name: "char array initializer",
  ...
  {
    cat: "Properties",
    name: "Dot syntax property assignment (object type)",
    code:
...
for (const probe of probes) {
  ...
  if (!passed) {
    ...
    console.log(
      `       actual:   "${
        result.lastLine || result.output.trim().split("\n").pop() || "(empty)"
      }"`,
    );
