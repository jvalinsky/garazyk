...
**Last updated:** 2026-05-06 **Current test status:** 84/84 runtime gap probes passing
**Cross-reference:** `kernel/PARSER_STATUS.md`, `docs/runtime-gap-report.md`

## Overview

This document summarizes the current state of Objective-C runtime features in the WASM kernel. The
kernel implements a custom recursive-descent interpreter for Objective-C 2.0 syntax, compiled to
