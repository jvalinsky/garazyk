(function (global) {
  ...
  function initSearchPanel(bridge) {
    ...
    container.innerHTML = '<div class="skylab-panel-header">' +
    ...
    function setActiveTab(tabId) {
      tabs.querySelectorAll(".skylab-tab").forEach((t) =>
    ...
    async function doSearch() {
      ...
      const [actorsResp, postsResp] = await Promise.all([
        bridge.xrpc("app.bsky.actor.searchActors", { q, limit: 20 }, null, {
          service: "appview",
          auth: !!bridge.auth,
        }),
        bridge.xrpc("app.bsky.feed.searchPosts", { q, limit: 20 }, null, {
          service: "appview",
          auth: !!bridge.auth,
        }),
      ]);
