...
function initFirehosePanel(bridge) {
    ...
    bridge.on('firehose_open', () => {
        eventsEl.innerHTML = '<div class="skylab-empty-state" style="color:var(--color-success);">Connected to firehose</div>';
    });
    ...
    bridge.on('firehose_error', () => {
        eventsEl.innerHTML = '<div class="skylab-empty-state" style="color:var(--color-destructive);">Connection error</div>';
    });
