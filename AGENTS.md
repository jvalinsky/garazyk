...
Production config: `docker/pds/config.json` (read-only mount). VM: `crimson-comet.exe.xyz`. Architecture: `exe.dev HTTPS → nginx:3000 → PDS:2583`.
