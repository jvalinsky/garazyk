...
Curated test scenarios that exercise terminal rendering edge cases for semantic recognition training.
...
| Variation Selectors | Emoji presentation width changes | crafted grid | [variation_selectors.yaml](variation_selectors.yaml) |
| Kitty Protocol | Extended key sequences | kitty terminal | [kitty_protocol.yaml](kitty_protocol.yaml) |
