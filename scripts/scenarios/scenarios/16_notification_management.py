...
def run() -> ScenarioResult:
    ...
    for follower_name in ["marcus", "rosa", "volt"]:
        ...
        if fchar.did and fchar.access_jwt and luna.did:
            timed_call(
                ...
                lambda c=fchar: client.create_record(
    ...
    timed_call(
        ...
        lambda: client.list_notifications(luna.access_jwt),
    ...
    timed_call(
        ...
        lambda: client.xrpc_get("app.bsky.notification.getUnreadCount", token=luna.access_jwt),
    ...
    timed_call(
        ...
        lambda: client.update_seen(luna.access_jwt, limit=0),
        skip_on_status={404},
    )
    ...
    timed_call(
        ...
        lambda: client.get_notification_preferences(luna.access_jwt),
    ...
    timed_call(
        ...
        lambda: client.put_notification_preferences({"priority": True}, luna.access_jwt),
        skip_on_status={404},
    )
    ...
    if marcus.did:
        timed_call(
            ...
            lambda: client.put_activity_subscription(
    ...
    timed_call(
        ...
        lambda: client.list_activity_subscriptions(luna.access_jwt),
