...
def generate_test_content(class_name, methods, header_path):
    ...
    if "ATProtoPDS/Sources/" in header_path:
        import_path = header_path.split("ATProtoPDS/Sources/")[1]
...
def main():
    ...
    parser.add_argument('--output', help='Output directory for the test file', default='ATProtoPDS/Tests/CharacterizationTests')
