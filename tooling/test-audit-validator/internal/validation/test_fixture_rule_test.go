...
func TestTestFixtureRule_WithFixtureAndAssertion(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/MSTTests.m"}
...
func TestTestFixtureRule_WithoutAssertion(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/FixtureTests.m"}
...
func TestTestFixtureRule_NoFixture(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/ProcessorTests.m"}
...
func TestTestFixtureRule_DirectFileLoad(t *testing.T) {
	...
	method := &models.TestMethod{
		...
		LineNumber: 10,
		SourceCode: `
			NSString *fixturePath = @"Garazyk/Tests/fixtures/example.json";
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/ParserTests.m"}
...
func TestTestFixtureRule_FixtureInAssertion(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/EncoderTests.m"}
...
func TestTestFixtureRule_MultipleFixtures(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/TransformerTests.m"}
...
func TestTestFixtureRule_FixtureWithExpectedVariable(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/GeneratorTests.m"}
...
func TestTestFixtureRule_StringFixture(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/RendererTests.m"}
...
func TestTestFixtureRule_CARFixture(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/CARTests.m"}
...
func TestTestFixtureRule_ExtractFixturePaths(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			sourceCode: `
				NSString *path = @"Garazyk/Tests/fixtures/example.json";
			`,
			wantPaths: 1,
		},
		{
