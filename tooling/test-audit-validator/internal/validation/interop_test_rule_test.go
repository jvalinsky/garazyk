...
func TestInteropTestRule_WithFixtureAndComparison(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/MSTInteropTests.m"}
...
func TestInteropTestRule_WithoutFixture(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/InteropTests.m"}
...
func TestInteropTestRule_CARInterop(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/CARInteropTests.m"}
...
func TestInteropTestRule_CBORCanonicalEncoding(t *testing.T) {
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/CBORInteropTests.m"}
...
func TestInteropTestRule_FixturePathInName(t *testing.T) {
	...
	method := &models.TestMethod{
		...
		LineNumber: 10,
		SourceCode: `
			NSString *fixturePath = @"Garazyk/Tests/fixtures/reference-output.json";
	...
	file := &models.TestFile{Path: "Garazyk/Tests/Core/ReferenceTests.m"}
