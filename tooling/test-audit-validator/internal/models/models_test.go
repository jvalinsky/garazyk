...
func TestTestFileCreation(t *testing.T) {
	testFile := TestFile{
		Path:    "Garazyk/Tests/Auth/OAuthTests.m",
		Classes: []TestClass{},
		Imports: []string{"<XCTest/XCTest.h>", "\"OAuth.h\""},
	}

	if testFile.Path != "Garazyk/Tests/Auth/OAuthTests.m" {
...
func TestTestClassCreation(t *testing.T) {
	...
	testClass := TestClass{
		Name:      "OAuthTests",
		FilePath:  "Garazyk/Tests/Auth/OAuthTests.m",
		Methods:   []TestMethod{},
		BaseClass: &baseClass,
		IsHelper:  false,
	}
...
func TestNilBaseClass(t *testing.T) {
	testClass := TestClass{
		Name:      "TestHelper",
		FilePath:  "Garazyk/Tests/Helpers/TestHelper.m",
		Methods:   []TestMethod{},
		BaseClass: nil,
		IsHelper:  true,
	}
