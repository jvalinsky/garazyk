	...
	return []validation.Finding{
		{
			...
			TestMethod: "testAuth",
			TestClass:  "AuthTests",
			FilePath:   "Garazyk/Tests/Auth/AuthTests.m",
		},
		{
			RuleName:   "no-assert",
			...
			FilePath:   "Garazyk/Tests/Network/NetworkTests.m",
		},
		{
			...
			TestMethod: "testCore",
			TestClass:  "CoreTests",
			FilePath:   "Garazyk/Tests/Core/CoreTests.m",
		},
		{
			...
			TestClass:  "AuthTests",
			FilePath:   "Garazyk/Tests/Auth/AuthHelperTests.m",
		},
	}
}
