...
This document outlines a comprehensive set of debugging and administration tools for the Objective-C PDS implementation. The plan draws inspiration from the Pegasus OCaml PDS implementation while adding tools specific to the Objective-C/macOS ecosystem.
