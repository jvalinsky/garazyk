...
- (CPView)rootView
{
    ...
    [title setAccessibilityLabel:@"AppView Backfill Dashboard Title"];
...
- (CPView)buildMetricCardWithTitle:(CPString)title value:(CPString)value frame:(CGRect)frame color:(CPColor)color
{
    ...
    [card setAccessibilityLabel:title + " metric card"];
...
- (void)buildRepoStatusInView:(CPView)parent atY:(float)startY
{
    ...
    [sectionTitle setAccessibilityLabel:@"Repository status breakdown section"];
    ...
    for (var i = 0; i < statusItems.length; i++)
    {
        ...
        [valueField setAccessibilityLabel:item.label + " value"];
...
- (void)buildLagSectionInView:(CPView)parent atY:(float)startY
{
    ...
    [sectionTitle setBezeled:NO];
    [sectionTitle setDrawsBackground:NO];
    [sectionTitle setAccessibilityLabel:@"Ingest lag by relay section"];
    [parent addSubview:sectionTitle];
    ...
    [_lagTable setAccessibilityLabel:@"Lag by relay table"];
...
- (void)buildAdminControlsInView:(CPView)parent atY:(float)startY
{
    ...
    [sectionTitle setBezeled:NO];
    [sectionTitle setDrawsBackground:NO];
    [sectionTitle setAccessibilityLabel:@"Admin controls section"];
    [parent addSubview:sectionTitle];
    ...
    [_adminTokenField setAccessibilityLabel:@"Admin token input"];
    ...
    [_didsField setAccessibilityLabel:@"DIDs to enqueue input"];
    ...
    [enqueueButton setAccessibilityLabel:@"Enqueue DIDs for backfill"];
    ...
    [rebuildButton setAccessibilityLabel:@"Rebuild relevance scope"];
    ...
    [refreshButton setAccessibilityLabel:@"Refresh status now"];
    ...
    [resultText setAccessibilityLabel:@"Result output"];
